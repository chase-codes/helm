...
const CLASSIC_LIGHT: Palette = { appBg: '#e7e5e0', panel: '#f1efeb', panel2: '#f9f8f5', panel3: '#ffffff', text: '#24231f', dim: '#6c6960', faint: '#96928a', hairline: 'rgba(0,0,0,.07)', border: 'rgba(0,0,0,.12)', inputBg: '#ffffff', accent: '#a76a17', accentInk: '#fffaf2', live: '#b2453b', scripture: '#2f5cab', sermon: '#3d6f52', message: '#6b46a0', selBg: '#f6ead2', lineDim: '#5f5c53', go: '#237d45' };
